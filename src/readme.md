...
3. Cada vez que toques la comida, ganarás puntos y la comida reaparecerá en una posición aleatoria.
...
* **JavaScript (Vanilla):** 
  ...
  * Lógica de movimiento y detección de colisiones (Bounding Box / Distancia).
  * Generación de posiciones aleatorias para la comida.
